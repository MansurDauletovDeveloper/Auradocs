        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresLegalReview = table.Column<bool>(type: "boolean", nullable: false),
                    LegalReviewCompleted = table.Column<bool>(type: "boolean", nullable: false),
                    ArchivedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    RetentionPeriodMonths = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanBlock = table.Column<bool>(type: "boolean", nullable: false),
                    DelegatedToId = table.Column<string>(type: "text", nullable: true),
                    ...
                    SuggestedChanges = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentRole = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    CanDownload = table.Column<bool>(type: "boolean", nullable: false),
                    CanPrint = table.Column<bool>(type: "boolean", nullable: false),
                    CanExport = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DocumentId = table.Column<int>(type: "integer", nullable: false),
                    BlockedById = table.Column<string>(type: "text", nullable: false),
                    ...
                    UnblockedById = table.Column<string>(type: "text", nullable: true),
                    UnblockComment = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalRequests_DocumentId_ApproverId",
                table: "ApprovalRequests",
                columns: new[] { "DocumentId", "ApproverId" });
